  ...
  public static void main(String[] args) {
    ...
    // Prompt the user for another number and store their input in num2
      ...
      case 1:
      	...
      	System.out.println("The sum of both numbers is : " + answer);
      	break;
      case 2:
      	answer = findAverage(num1, num2);
      	System.out.println("The average of both numbers is : " + answer);
      	break;
      case 3:
      	answer = calcTax(num1, num2);
      	System.out.println("The tax for both numbers is : " + answer);
      	break;
      case 4:
      	keepGoing = false;
      	break;
